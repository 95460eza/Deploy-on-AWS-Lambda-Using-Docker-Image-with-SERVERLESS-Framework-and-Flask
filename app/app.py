...
# For the deployment of a Flask application on AWS Lambda an "API Gateway" is ALSO CREATED that triggers the Lambda function.It WILL take care of the execution s
